...
releases/de/ochmanski/microservices/quarkus-jpa-example:###CI_COMMIT_TAG###
```
...
--mount type=bind,source=$PWD/src/main/resources/application-docker.yml,\
target=/work/config/application.yml \
-it snapshots/de/ochmanski/microservices/quarkus-jpa-example:###CI_COMMIT_TAG###-SNAPSHOT
```
